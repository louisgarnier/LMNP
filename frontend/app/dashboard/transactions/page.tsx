            ...
            <div style={{ 
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: '500',
                  backgroundColor: mappingSubTab === 'existing' ? '#1e3a5f' : 'transparent',
                  color: mappingSubTab === 'existing' ? 'white' : '#666',
                  border: 'none',
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: '14px',
                  fontWeight: '500',
                  backgroundColor: mappingSubTab === 'allowed' ? '#1e3a5f' : 'transparent',
                  color: mappingSubTab === 'allowed' ? 'white' : '#666',
                  border: 'none',
